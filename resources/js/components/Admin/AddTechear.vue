                ...
                <form class="form-valide" action="#" method="post">
                  <div class="row mb-3">
                    ...
                    <div class="col-lg-6">
                      ...
                      <input
                        type="password"
                        v-model="this.FromProf.password"
                        class="form-control"
                        id="val-username"
                        name="val-username"
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-6">
                      ...
                      <input
                        type="password"
                        class="form-control"
                        v-model="this.FromProf.password2"
                        id="val-username"
                        name="val-username"
...
export default {
  ...
  methods: {
    ...
    AddProf() {
      axios.post("/add/prof", this.FromProf).then(response => {
        console.log("test");
      });
    },
    GetSubjects() {
    ...
    GetGrades(item) {
      this.GradesName = [];
      axios.get("/grades/" + this.CyclesName).then(response => {
        if (response.data["status"] == "success") {
